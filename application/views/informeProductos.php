                            ...
                            <div class="col-lg-12">  
                                <div class="card">                                   
                                    <div class="card-body">
                                        ...
                                        <button class="btn btn-outline-success btn-block" @click='exportarExcel()'>IMPORTAR LISTA PRODUCTOS A EXCEL</button>
                                        <br>
                                        <h5 class="card-title">Productos por categorias</h5>
                                        <div class="table-responsive">
                                            <table class="table table-striped table-bordered table-hover table-sm">
                                                ...
                                                <tbody v-for = '(u, index) in listaCategorias' v-show="(pag - 1) * NUM_RESULTS <= index && pag * NUM_RESULTS > index">
                                                <td class="font-weight-bold">{{u.idcategoria}}</td>
                                                <td class="font-weight-bold">{{u.nombre}}</td>
                                                <td>{{u.descripcion}}</td>  
                                                <td>{{u.estado}}</td>
                                                <td class='text-center font-weight-bold' >{{u.cantidadProd}}</td>
...
<!--                    <pre>{{$data}}</pre>-->
        ...
        <script src="<?= base_url() ?>assets/js/informeProductos.js"></script>
